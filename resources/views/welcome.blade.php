...
<head>
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/css/bootstrap.min.css"
        integrity="sha384-w8iqmrXZ5+V+u6NzN5O7m4/yAjcVfzt3fnjflwuuFCRiP9uOgkfn4s1Gj+nKC8fY" crossorigin="anonymous" />

    <!-- My Style -->
    <link rel="stylesheet" href="assets/css/styleAwal.css" />
    <link rel="icon" href="assets/images/landingPage/logo.png">
</head>
...
<body>
    ...
    <nav class="navbar">
        <a href="#" class="navbar-logo">
            <img src="assets/images/landingPage/logo.png" width="60" height="60" alt="Logo" />
        </a>
        ...
        <div class="nav">
            ...
            <div class="navbar-extra">
                ...
                <div class="signUp">
                    <a class="signUp" href=""><span id="register">Sign Up</span></a>
                </div>
            </div>
            <div class="navbar-menu">
                <a href="#menu" id="menu"><img src="assets/images/landingPage/menu.svg" alt=""></a>
            </div>
        </div>
    </nav>
    <!-- Navbar end -->
    ...
    <section class="hero" id="home">
        <div class="row">
            ...
            <div class="home-img">
                <img src="assets/images/landingPage/home.png" />
            </div>
    ...
    <section id="review" class="review">
        ...
        <div class="row">
            <div class="review-img">
                <img src="assets/images/landingPage/ulasan1.png" />
                <img src="assets/images/landingPage/ulasan2.png" />
                <img src="assets/images/landingPage/ulasan3.png" />
                <img src="assets/images/landingPage/ulasan4.png" />
            </div>
        </div>
    ...
    <section id="features" class="features">
        ...
        <div class="row">
            <div class="menu-card">
                <img src="assets/images/landingPage/formPengaduan.svg" class="menu-card-img"
                    style="padding: 3.5rem 6vw" />
                <h3 class="menu-card-title">Form Pengaduan</h3>
            </div>
            <div class="menu-card">
                <img src="assets/images/landingPage/private1.png" class="menu-card-img" />
                <h3 class="menu-card-title">Konseling</h3>
            </div>
            <div class="menu-card">
                <img src="assets/images/landingPage/Panggilan darurat.svg" class="menu-card-img"
                    style="padding: 4rem" />
    ...
    <section id="rules" class="rules">
        <div class="row">
            <div class="rules-img">
                <img src="assets/images/landingPage/rules.png" />
            </div>
            <div class="content">
                <h1>Konseling</h1>
                <p>
        ...
        <section id="about">
            <div class="left">
                <div class="footer-img">
                    <img src="assets/images/landingPage/logoSatgasPPKS.svg" />
                </div>
                ...
                <div class="contentFooter">
                    ...
                    <div class="contact">
                        <div class="address" style="display: flex">
                            ...
                            <a style="padding-left: 10px" href="https://goo.gl/maps/8pnqYp4d56Lzh9Su7"
                                id="map">Jalan Raya Jember No.KM13, Kawang, Labanasem, Kec. Kabat, Kabupaten
                                Banyuwangi, Jawa Timur 68461</a>
                        </div>
                        <div class="email">
                            <a href="#" id="email"><i data-feather="mail"></i></a>
                            <a href="mailto:satgasppkspoliwangi@gmail.com"
                                style="padding-left: 10px">satgasppkspoliwangi@gmail.com</a>
                        </div>
                        <div class="social-media">
                            <a href="#" id="instagram"><i data-feather="instagram"></i></a>
                            <a href="https://www.instagram.com/satgasppks_poliwangi/" style="padding-left: 10px"
                                id="instagram">Satgas
                                PPKS Poliwangi</a>
                        </div>
                    </div>
